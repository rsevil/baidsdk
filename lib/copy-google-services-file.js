...
module.exports = function() {
    console.log("Copying google Services Configuration");
  ...
  sourceGoogleJson = path.join(__dirname, "..", "..","..", "app", "App_Resources", "iOS", "GoogleService-Info.plist");
  destinationGoogleJson = path.join(__dirname, "..", "..","..", "platforms", "ios", "GoogleService-Info.plist");
   if (fs.existsSync(sourceGoogleJson) && fs.existsSync(path.dirname(destinationGoogleJson))) {
       console.log("Copy " + sourceGoogleJson + " to " + destinationGoogleJson + ".");
       fs.writeFileSync(destinationGoogleJson, fs.readFileSync(sourceGoogleJson));
   }
