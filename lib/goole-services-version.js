...
module.exports = function() {
    ...
    console.log("Configure google Services Version");
    ...
    if (fs.existsSync(buildGradlePath)) {
        ...
        if (buildGradleContent.indexOf('classpath "com.google.gms:google-services:3.0.0"') != -1) {
            buildGradleContent = buildGradleContent.replace('classpath "com.google.gms:google-services:3.0.0"', 'classpath "me.tatarka:gradle-retrolambda:3.7.0"\n    classpath "com.google.gms:google-services:3.1.1"');
        ...
        buildGradleContent = buildGradleContent.substr(0, search - 1) + 'classpath "me.tatarka:gradle-retrolambda:3.7.0"\n    classpath "com.google.gms:google-services:3.1.1"\n    ' + buildGradleContent.substr(search - 1);
